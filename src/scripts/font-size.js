const
    ...
    s3 = 'text-[1.775rem] leading-[2rem] md:text-[2.275rem] md:leading-[2.35rem] lg:text-[3.125rem] lg:leading-[3.375rem]',
    ...
    sx1 = 'text-[1.015rem] leading-[1.455rem] md:text-[1.0875rem]',
    sx2 = 'text-[1.25rem] leading-[1.45rem] md:text-[1.3rem] md:leading-[1.65rem]',
    copy = 'text-[1.0725rem] leading-[1.395rem] lg:text-[1.15rem] lg:leading-[1.5rem]',
