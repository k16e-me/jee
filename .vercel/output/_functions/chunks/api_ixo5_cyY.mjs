...
const $$NavMobile = createComponent(($$result, $$props, $$slots) => {
  ...
  const { nav, class: classes, ...props } = Astro2.props;
  const hub = _settings.value.tools[2];
